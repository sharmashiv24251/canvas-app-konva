...
export default function SidebarListItem({
  ...
  return (
    <div className="group/item relative flex items-center gap-3 px-3 py-3 hover:bg-white/[0.05] transition-colors">
      ...
      <button
        className="ml-auto inline-flex items-center justify-center h-8 w-8 rounded-md border border-white/10 bg-white/0 hover:bg-white/10 transition-colors cursor-grab active:cursor-grabbing focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500/40"
        aria-label="Reorder"
      >
